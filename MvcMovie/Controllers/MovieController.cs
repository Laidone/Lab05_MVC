...
namespace MvcMovie.Controllers
{
   public class MovieController : Controller
   {
      ...
      [HttpPost]
      [ValidateAntiForgeryToken]
        //[DateActionFilter(_name = "director", _date = "releaseDate", _operacao = "Edit")]
        [DateActionFilter]
      public ActionResult Edit(int id, string title, string director,
      DateTime releaseDate, decimal gross, double rating, string imageUrl, int genreID,  HttpPostedFileBase image)
        {
